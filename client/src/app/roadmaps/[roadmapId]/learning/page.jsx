        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <div className="p-6">
            <div className="prose max-w-none mb-8">
              ...
              {/* Format the content properly using react-markdown */}
                  ...
                  <div className="markdown-content">
                    <ReactMarkdown
                      ...
                      components={{
                        ...
                        h4: ({node, ...props}) => <h4 className="text-md font-semibold mt-3 mb-2" {...props} />,
                        ...
                        code: ({node, inline, className, children, ...props}) => {
                          ...
                          return !inline && match ? (
                            <div className="my-4 overflow-auto rounded-md bg-gray-800 p-4">
                              <code className={`${className} text-sm text-white`} {...props}>
                                {children}
                              </code>
                            </div>
                          ) : (
                        ...
                        th: ({node, ...props}) => <th className="border border-gray-300 p-2 text-left" {...props} />,
